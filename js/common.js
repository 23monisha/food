jQuery(document).ready(function() {
	...
	if(ww < 767){
		jQuery(".logo div").addClass("img-res");
	}
    ...
    jQuery("#nav li.level0.drop-menu").mouseover(function() {
		...
		/*$(function () {
			...
			if (ww < 320) {
				//alert("size" + ww);
				console.log(ww);
				jQuery('#best-seller').removeClass('owl-carousel owl-theme');
			}
    	});*/
        /*  Best Seller Slider */
	...
	if (jQuery(window).width() > 767) {
		...
		//console.log(ww);
		//jQuery(".slider-items").removeClass("owl-carousel");
		//jQuery(".owl-controls").hide();
		
		//jQuery('#sliDiv').removeClass('owl-carousel');
	}
